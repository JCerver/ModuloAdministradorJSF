...
public class RegistrarMesero {
    ...
    public RegistrarMesero() throws SQLException, ClassNotFoundException {
        gestor = new GestorMeseroBD();
    }
    public void registrar(){
        Mesero mesero = new Mesero(0, nombre, apellidos, correo, usuario, password,0,0, 1);
        gestor.addMesero(mesero);
        this.redirigir("");
    }
